    ...
    PluginManager.add('image', function (editor) {
      ...
      function showDialog(imageList) {
        ...
        if (editor.settings.image_description !== false) {
          generalFormItems.push({ slug: 'alt', type: 'textbox', label: 'Image description' });
        }

        if (editor.settings.image_title) {
          generalFormItems.push({ slug: 'title', type: 'textbox', label: 'Image Title' });
        }
        ...
        if (editor.settings.image_caption && Env.ceFalse) {
          generalFormItems.push({ slug: 'caption', type: 'checkbox', label: 'Caption' });
        }
